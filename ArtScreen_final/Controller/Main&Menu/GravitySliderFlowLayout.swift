...
open class GravitySliderFlowLayout: UICollectionViewFlowLayout {
    ...
    func setup(for scrollDirection: UICollectionView.ScrollDirection, with collectionViewSize: CGSize) {
        ...
        case .vertical: break
        @unknown default:
            fatalError("DEBUG: Error in GravitySliderFlowLayout setup")
        }
    }
    ...
    override open func layoutAttributesForElements(in rect: CGRect) -> [UICollectionViewLayoutAttributes]? {
        ...
        case .vertical:
            return nil
        @unknown default:
            fatalError("DEBUG: Error in GravitySliderFlowLayout layoutAttributesForElements")
        }
    }
    ...
    override open func targetContentOffset(forProposedContentOffset proposedContentOffset: CGPoint,
        ...
        case .vertical:
            return CGPoint.zero
        @unknown default:
            fatalError("DEBUG: Error in GravitySliderFlowLayout targetContentOffset")
        }
    }
